        ...
        <form ref={formRef} action={action} className="space-y-6">
          ...
          {!preview ? (
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold text-gray-300">Scanner mon blister</p>
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white">
                ...
                <button
                  type="button"
                  onClick={handleReset}
                  className="absolute right-3 top-3 rounded-full bg-white/20 p-1.5 shadow hover:bg-white/30 transition-colors"
              ...
              <div className="flex gap-3">
                <button
                  ...
                  onClick={handleReset}
                  disabled={pending}
                  className="flex-1 rounded-lg border border-white/15 px-4 py-2.5 text-sm font-medium text-gray-300 hover:bg-white/10 disabled:opacity-50 transition-colors"
                >
                  Changer
                </button>
                <button
